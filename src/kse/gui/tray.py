...
from kse.gui.icons import themed, tray_icon
from kse.gui.summary import Summary, summarize
...
class Tray(QObject):
    def __init__(
        ...
        *,
        ...
        self.menu.addSeparator()
        self.open = self.menu.addAction(themed("configure"), _("Open KSE"))
