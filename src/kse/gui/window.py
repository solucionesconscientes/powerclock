...
from kse.gui.diagnostics import DiagnosticsTab
from kse.gui.history import HistoryTab
from kse.gui.icons import app_icon, themed
from kse.gui.quick import QuickTab
from kse.gui.rules import RulesTab
from kse.gui.summary import summarize
...
class MainWindow(QMainWindow):
    ...
    def _update(self) -> None:
        ...
        self.banner_text.setText(
            _("The KSE daemon is not running, so rules do not run. Start the service.")
        )
        ...
        self.setWindowTitle("KSE" + (" — " + _("dry run") if dry else ""))
