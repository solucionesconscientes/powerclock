...
from kse.connection import format_detail
from kse.gui.client import DaemonLink
from kse.gui.forms import ActionEditor, EditorList, ModelForm, PredicateEditor, TriggerEditor
from kse.gui.icons import app_icon
from kse.gui.tasks import spawn
from kse.i18n import _
from kse.models import Guards, Rule
...
def _new_rule() -> dict[str, Any]:
    return {
        ...
        "actions": [{"type": "notify", "title": "KSE", "body": ""}],
    }
